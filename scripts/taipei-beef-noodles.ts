...
const DISTRICT_BOUNDARIES = {
    中正區: { lat: [25.025, 25.05], lng: [121.505, 121.525] },
    大同區: { lat: [25.05, 25.075], lng: [121.505, 121.53] },
    中山區: { lat: [25.05, 25.085], lng: [121.52, 121.55] },
    松山區: { lat: [25.04, 25.065], lng: [121.55, 121.585] },
    大安區: { lat: [25.015, 25.045], lng: [121.52, 121.56] },
    萬華區: { lat: [25.025, 25.05], lng: [121.48, 121.515] },
    信義區: { lat: [25.02, 25.045], lng: [121.56, 121.605] },
    士林區: { lat: [25.075, 25.13], lng: [121.48, 121.59] }, // 面積最大
    北投區: { lat: [25.105, 25.15], lng: [121.435, 121.54] },
    內湖區: { lat: [25.055, 25.095], lng: [121.58, 121.63] },
    南港區: { lat: [25.025, 25.06], lng: [121.6, 121.65] },
    文山區: { lat: [24.95, 25.02], lng: [121.54, 121.59] },
};
